...
BEGIN
  ...
  RAISE NOTICE '>> Load Duration: % seconds', EXTRACT(EPOCH FROM (clock_timestamp() - v_start))::int;
  RAISE NOTICE '>> -------------';
  ...
  RAISE NOTICE '   - Total Load Duration: % seconds', EXTRACT(EPOCH FROM (clock_timestamp() - v_batch_start))::int;
  RAISE NOTICE '==========================================';
